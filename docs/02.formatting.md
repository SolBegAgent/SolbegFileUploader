...
- `image/inline` is alias of `Bicycle\FilesManager\Formatters\Image\InlineFormatter`
...
- `inline`: `Bicycle\FilesManager\Formatters\InlineFormatter`
- `image/inline`: `Bicycle\FilesManager\Formatters\Image\InlineFormatter`
...
```php
    'format-name' => [
        'image/watermark', // alias to Bicycle\FilesManager\Formatters\WatermarkFormatter::class
        'img' => null, // required, relative path to file in `$root` directory

        // Set a point from where the watermark will be inserted.
        // See possible values in PHPDoc to the property in Bicycle\FilesManager\Formatters\WatermarkFormatter class
...
- `Bicycle\FilesManager\Formatters\InlineFormatter` $formatter or
    `Bicycle\FilesManager\Formatters\Image\InlineFormatter` $formatter,
